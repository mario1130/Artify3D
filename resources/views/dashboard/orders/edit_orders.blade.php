            ...
            <form action="{{ route('admin.orders.update', $order->id) }}" method="POST"
                ...
                <div class="form-fields-center">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="status" name="status" value="{{ old('status', $order->status) }}"
                            required placeholder="Estado del pedido">
                        @error('status')
                            <div class="error-message" style="color: #e11d48;">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" id="total" name="total" value="{{ old('total', $order->total) }}"
                            required step="0.01" min="0" placeholder="Total">
                        @error('total')
                            <div class="error-message" style="color: #e11d48;">{{ $message }}</div>
                        @enderror
                    </div>
