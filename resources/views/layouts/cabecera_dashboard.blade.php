<header>
    <nav class="cabecera">
        <ul>
            <a class="logo" href="{{ route('admin.dashboard') }}"><img src="{{ asset('img/favicon_artify.png') }}"
                    alt=""></a>
            <a>ARTIFY3D</a>
        </ul>
    </nav>
    ...
    <div class="cabecera2">
        ...
        <div id="adminNotificationPopup" class="admin-notification-popup" style="display:none;">
            <div class="popup-header">
                ...
                <button id="closeAdminNotificationPopup"
                    style="background:none;border:none;font-size:1.5em;float:right;">&times;</button>
            </div>
                    ...
                    @forelse($adminNotifications as $notification)
                        <div class="admin-notification-item{{ $notification->read_at ? ' read' : '' }}">
                            <div>
                                ...
                                <span
                                    style="font-size:0.9em;color:#888;">{{ $notification->created_at->diffForHumans() }}</span>
                            </div>
                            <div>{{ $notification->message ?? '' }}</div>
                            <div class="acciones">
                                <a href="{{ route('admin.notifications.read', $notification->id) }}">Marcar como
                                    leída</a>
...
<div class="side-menu" id="sideMenu">
    <ul>
        <li><a href="{{ route('admin.dashboard') }}"><img src="{{ asset('/img/admin/rayas.png') }}"
                    alt="rayas"></a></li>
        <li><a href="{{ route('admin.dashboard') }}"><img src="{{ asset('/img/admin/casa.png') }}" alt="casa"></a>
        </li>
    </ul>
    <hr class="separator">
    <ul>
        <li><a href="{{ route('admin.users.index') }}"><img src="{{ asset('/img/admin/user.png') }}"
                    alt="shopping"></a></li>
        <li><a href="{{ route('admin.orders.index') }}"><img src="{{ asset('/img/admin/shopping.png') }}"
                    alt="shopping"></a></li>
        <li><a href="{{ route('admin.products.index') }}"><img src="{{ asset('/img/admin/tienda.png') }}"
                    alt="tienda"></a></li>
        <li><a href="{{ route('admin.categories.index') }}"><img src="{{ asset('/img/admin/category.png') }}"
                    alt="category"></a></li>
        <li><a href="{{ route('admin.comments.index') }}"><img src="{{ asset('/img/admin/mensaje.png') }}"
                    alt="mensaje"></a></li>
        <li><a href="{{ route('admin.returns.index') }}"><img src="{{ asset('/img/admin/devolver.png') }}"
                    alt="devolver"></a></li>
    </ul>
    <hr class="separator">
    <ul>
        <li><a href="{{ route('admin.notifications.index') }}"><img src="{{ asset('/img/admin/comentario.png') }}"
                    alt="comentario"></a></li>
        <li><a href="{{ route('admin.soporte.index') }}"><img src="{{ asset('/img/admin/support.png') }}"
                    alt="support"></a></li>
        <li><a href="{{ route('admin.log_admin.index') }}"><img src="{{ asset('/img/admin/monitoreo.png') }}"
                    alt="monitoreo"></a></li>
    </ul>
</div>
