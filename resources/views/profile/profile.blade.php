...
.barra-nivel {
  ...
  height: 24px; /* aumenta la altura si quieres */
  width: 200px;
  border-radius: 5px;
  position: relative;
  overflow: hidden;
...
.barra-nivel-progreso span {
  ...
  left: 0;
  top: 0;
  line-height: 24px; /* igual que la altura de la barra */
  color: #fff;
  font-weight: bold;
  font-size: 0.95em;
...
@media (max-width: 700px) {
  ...
  .preview-container, .cropper-crop-box, .cropper-view-box {
...
@php
    ...
    if ($nextLevelName == '') $nextLevelName = $levelNames[101];
@endphp
<div class="space">
