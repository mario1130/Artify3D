...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .shop-logo { margin-top: 15px; }
            .item-table th, .item-table td { padding: 8px; }
            .summary-table { width: 100%; float: none; margin-left: 0; margin-right: 0; }
            .address-section { flex-direction: column; }
            .address-box { width: 100%; padding-right: 0; }
        }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="footer-notes">
            <p>Este documento es informativo, no siendo equivalente a la factura oficial. Recibirás un email con la factura de tu compra realizada en Artify3D en un máximo de 24 horas tras haber recepcionado tu pedido. Para cualquier pregunta relacionada con la misma puedes ponerte en contacto con nuestro servicio de atención al cliente.</p>
        </div>
    </div>
</body>
</html>