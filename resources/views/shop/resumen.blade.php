...
@section('context')
    ...
    <div class="steps">
        ...
        <div class="step active-step"><span>3</span>
            <div>Resumen</div>
        </div>
    </div>
            ...
            <div class="product-summary">
                @if ($order && $order->items->count())
                    @foreach ($order->items as $item)
                        @php
                            // Obtén el producto relacionado (ajusta el modelo si es necesario)
                    ...
                    <button class="download-btn"
                        onclick="window.location='{{ route('factura.descargar', $order->id) }}'">Descargar Factura</button>
                @else
